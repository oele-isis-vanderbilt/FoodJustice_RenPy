...
screen learningbuttons():
    ...
    vbox style "side_button":
        ...
        imagebutton:
            tooltip "Test AI Agents"
            idle "images/robot.png"
            hover "images/robot light.png"
            action Jump("select_agent")
...
### Agent comparison screen ###

screen three_agents(eca, image, llama, gpt, flan):
    modal True
    add "images/[image].png" pos (0.6,0.2)
    add "images/three bubbles.png"
    zorder 95

    imagebutton:
        idle "images/tryagain.png"
        hover "images/tryagain dark.png"
        action Hide(screen="three_agents") 
        anchor (0.5, 0.0)
        pos (0.6,0.03)
    ...
    viewport:
        ...
        hbox:
            imagebutton:
                idle "images/thumbs up.png"
                action (Function(log_http, current_user, action="ThumbsUp", view="Llama", payload={"input": eca, "response": llama}, _update_screens=False), Notify("Feedback recorded - Thumbs Up"))

            imagebutton:
                idle "images/thumbs down.png"
                action (Function(log_http, current_user, action="ThumbsDown", view="Llama", payload={"input": eca, "response": llama}, _update_screens=False), Notify("Feedback recorded - Thumbs Down"))
    ...
    viewport:
        ...
        hbox:
            imagebutton:
                idle "images/thumbs up.png"
                action (Function(log_http, current_user, action="ThumbsUp", view="GPT", payload={"input": eca, "response": gpt}, _update_screens=False), Notify("Feedback recorded - Thumbs Up"))
            imagebutton:
                idle "images/thumbs down.png"
                action (Function(log_http, current_user, action="ThumbsDown", view="GPT", payload={"input": eca, "response": gpt}, _update_screens=False), Notify("Feedback recorded - Thumbs Down"))
    ...
    viewport:
        ...
        hbox:
            imagebutton:
                idle "images/thumbs up.png"
                action (Function(log_http, current_user, action="ThumbsUp", view="FlanT5", payload={"input": eca, "response": flan}, _update_screens=False), Notify("Feedback recorded - Thumbs Up"))
            imagebutton:
                idle "images/thumbs down.png"
                action (Function(log_http, current_user, action="ThumbsDown", view="FlanT5", payload={"input": eca, "response": flan}, _update_screens=False), Notify("Feedback recorded - Thumbs Down"))
